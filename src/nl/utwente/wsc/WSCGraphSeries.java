 ...
 * @author jjoe64
 */
public class WSCGraphSeries<E extends DataPointInterface> extends BaseSeries<E> {
    /**
    ...
    private final class Styles {
         ...
         * @see #drawBackground
         */
        private int backgroundColorHigh = Color.argb(100, 172, 218, 255);
         ...
         * @see #drawBackground
         */
        private int backgroundColorMedium = Color.argb(100, 172, 218, 255);
         ...
         * @see #drawBackground
         */
        private int backgroundColorLow = Color.argb(100, 172, 218, 255);
    }
    ...
    private int mTransitionMedium;
    
    private int mTransitionHigh;

    /**
     * creates a series without data
     */
    public WSCGraphSeries() {
        init();
    }
...
//    }
	...
	@Override
	public void draw(GraphView arg0, Canvas arg1, boolean arg2) {
